...
class UserController extends Controller
{
    ...
    public function getUser(){
        $users = Userform::all();
        //dd($users);
        return response()->json(['code'=>200, 'message'=>'Get data successfully','userdata' => $users]);
    }
    public function addUser(Request $request){
            ...
            if(!is_null($request->operation) && $request->operation=="save"){
                ...
                $userData->save();
                return response()->json(['code'=>200, 'message'=>'User Created successfully', 'lastId' => $userData->id]);
